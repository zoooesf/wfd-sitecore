...
const ArticleListingWithFiltersDefault: React.FC<SearchListingWithFiltersProps> = (props) => {
  ...
  return (
    <Frame params={props.params}>
      <WidgetsProvider
        ...
        debug={true}
      >
        <ArticleListingWithFiltersWidget rfkId={rfkId} props={props} key={itemId} />
      </WidgetsProvider>
    </Frame>
  );
};
...
export const Default = withDatasourceCheck()<SearchListingWithFiltersProps>(
  ArticleListingWithFiltersDefault
);
