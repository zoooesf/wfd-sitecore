...
const KnowledgeCenterSearchListingDefault: React.FC<GlobalSearchProps> = (props) => {
  const fields = props;
...
export const Default = withDatasourceCheck()<GlobalSearchProps>(
  KnowledgeCenterSearchListingDefault
);
