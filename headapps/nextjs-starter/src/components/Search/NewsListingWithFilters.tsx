...
import { NEWS_TEMPLATE_ID } from 'lib/graphql/id';
...
const NewsLisitngWithFiltersDefault: React.FC<SearchListingWithFiltersProps> = (props) => {
    ...
    <Frame params={props.params}>
      ...
      >
        <SearchListingWithFiltersWidget
          rfkId={rfkId}
          props={props}
          templateId={NEWS_TEMPLATE_ID}
          variant={ARTICLE_VARIANTS.NEWS}
          key={itemId}
        />
      </WidgetsProvider>
    </Frame>
