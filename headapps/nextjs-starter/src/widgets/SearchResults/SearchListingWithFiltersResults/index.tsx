...
type SearchListingWithFiltersResultsProps = {
...
export const SearchListingWithFiltersResults = ({
  ...
  props,
  templateId,
}: SearchListingWithFiltersResultsProps) => {
  ...
  const {
  ...
  } = useSearchResults<SearchModel, InitialState>({
    config: {
    ...
    query: (query) => {
      ...
      const templateIdFilter = new FilterEqual(
        'm_templateid',
        removeCurlyBraces(templateId).toLowerCase()
      );
  ...
  return (
    <>
      {isLoading ? (
        <ContainedWrapper>
          <SearchResultsContainer ref={widgetRef} data-component="SearchListingWithFiltersResults">
            <SearchSkeletonTheme>
                ...
                <MainContentContainer>
                  ...
                  {totalItems > 0 && (
                    <SearchResultsToolbar
                      ...
                      totalItemsReturned={contents.length}
...
const SearchListingWithFiltersWidget = widget(
  SearchListingWithFiltersResults,
  WidgetDataType.SEARCH_RESULTS,
  'content'
);

export default SearchListingWithFiltersWidget;
