...
export const SimplePageListingCard: React.FC<PageDataType> = (page) => {
...
const Wrapper: React.FC<{
  ...
  if (isEditing) {
    return (
      <div data-component="SimplePageListingCard" className={cardClasses}>
        {children}
      </div>
    );
  }
  ...
  return (
    <Link data-component="SimplePageListingCard" href={href} className={cardClasses}>
      {children}
    </Link>
  );
};
